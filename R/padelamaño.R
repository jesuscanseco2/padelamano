padelamaño<-function(g1,g2=NA,g3=NA,p1,p2=NA,p3=NA, ausencia=FALSE,empate=FALSE,fecha=NA){
  ...
  if (empate==TRUE){
    ...
    tabla<<-rbind(tabla,tibble(jugador=g1,puntos=puntos_ant[1]+12,jugados=jugados_ant[1]+1,ganados=ganados_ant[1],empatados=empatados_ant[1]+1,perdidos=perdidos_ant[1],fecha=ymd(fecha)))
    ifelse(is.na(g2),nada<-"nada",tabla<<-rbind(tabla,tibble(jugador=g2,puntos=puntos_ant[2]+12,jugados=jugados_ant[2]+1,ganados=ganados_ant[2],empatados=empatados_ant[2]+1,perdidos=perdidos_ant[2],fecha=ymd(fecha))))
    ifelse(is.na(g3),nada<-"nada",tabla<<-rbind(tabla,tibble(jugador=g3,puntos=puntos_ant[3]+12,jugados=jugados_ant[3]+1,ganados=ganados_ant[3],empatados=empatados_ant[3]+1,perdidos=perdidos_ant[3],fecha=ymd(fecha))))
